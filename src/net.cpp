...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Ezzycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ezzycointools.com", "95.141.45.238"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"ezzycointools.com", "testnet-seed.ezzycointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Ezzycoin is probably already running."), addrBind.ToString().c_str());
        else
